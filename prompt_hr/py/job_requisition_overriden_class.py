...
class JobRequisition(Document):
	...
	# ? FUNCTION TO CALCULATE TIME TO FILL A POSITION
	...
	# ? LINK JOB OPENING WITH THIS REQUISITION
	@frappe.whitelist()
...
# ? FUNCTION TO MAP JOB REQUISITION TO JOB OPENING
@frappe.whitelist()
...
# ? FUNCTION TO GET AVERAGE TIME TO FILL BASED ON FILTERS
@frappe.whitelist()
