...
def release_internal_job_posting(
	...
	company_cutoff = frappe.utils.add_days(frappe.utils.nowdate(), -(min_tenure_in_company * 30))
	role_cutoff = frappe.utils.add_days(frappe.utils.nowdate(), -(min_tenure_in_current_role * 30))
