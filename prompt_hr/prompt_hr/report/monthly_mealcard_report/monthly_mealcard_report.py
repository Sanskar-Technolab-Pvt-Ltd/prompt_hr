...
def get_data(filters):
    ...
    for slip in salary_slips:
        ...
        if employee.status=="Active" and (employee.custom_telephone_reimbursement_applicable or employee.custom_fuel_card_consent or employee.custom_attire_card_consent or employee.custom_meal_card_consent):
            mobile_no = employee.cell_number if employee.custom_preferred_mobile == "Personal Mobile No" else employee.custom_work_mobile_no
            row = {
