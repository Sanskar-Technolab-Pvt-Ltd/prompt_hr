frappe.ui.form.on("Full and Final Statement", {
  ...
  fetch_salary_structure: function(frm) {
    ...
    frappe.db.get_list("Salary Structure Assignment", {
      ...
      frm.set_value("custom_monthly_salary", (records && records.length > 0) ? records[0].base : 0);
    });
  },
  ...
  update_reference_document_requirement: function(frm) {
    ["receivables", "payables"].forEach(function(table_field) {
      ...
      frm.fields_dict[table_field].grid.update_docfield_property("reference_document", "reqd", 0);
      frm.fields_dict[table_field].grid.update_docfield_property("reference_document", "mandatory_depends_on", "");
